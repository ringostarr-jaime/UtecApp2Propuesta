 ...
 * {@link pagoFrag.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link pagoFrag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class pagoFrag extends Fragment {
     ...
     * @return A new instance of fragment pagoFrag.
     */
    // TODO: Rename and change types and number of parameters
    public static pagoFrag newInstance(String param1, String param2) {
        pagoFrag fragment = new pagoFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewroot=inflater.inflate(R.layout.fragment_pago, container, false);
...
Button pagar =(Button)viewroot.findViewById(R.id.pagosBtn);
        pagar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pagarFrag pago = new pagarFrag();
                FragmentManager manager5 = getFragmentManager();
                manager5.beginTransaction()
                        .setCustomAnimations(R.anim.anim_slide_in_from_left,R.anim.anim_slide_out_from_left)
                        .replace(R.id.contenido, pago, pago.getTag()).commit();
