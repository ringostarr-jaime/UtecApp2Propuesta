package com.example.jymmy.utecapp.Correo;
 ...
 * {@link correoUtec.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link correoUtec#newInstance} factory method to
 * create an instance of this fragment.
 */
public class correoUtec extends Fragment {
     ...
     * @return A new instance of fragment correoUtec.
     */
    // TODO: Rename and change types and number of parameters
    public static correoUtec newInstance(String param1, String param2) {
        correoUtec fragment = new correoUtec();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewroot=inflater.inflate(R.layout.fragment_correo_utec, container, false);
        Button gmail=(Button)viewroot.findViewById(R.id.gmailBtn);
        gmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gmailFrag gmailf = new gmailFrag();
                //En lugar de usar el getSupportFragmentManager usar getFragmentManager
                FragmentManager manager = getFragmentManager();
                manager.beginTransaction()
                        .setCustomAnimations(R.anim.anim_slide_in_from_left,R.anim.anim_slide_out_from_left)
                        .replace(R.id.contenido,gmailf, gmailf.getTag()).commit();
            }
        });
...
//Setear titulo
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("   Correo UTEC");
       ((AppCompatActivity)getActivity()).getSupportActionBar().setIcon(R.drawable.mailing);
